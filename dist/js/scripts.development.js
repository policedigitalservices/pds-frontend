...
if (main && main.classList.contains('asc-staff-index')) {
  ...
  var selectAll = function selectAll(toSelect) {
    ...
    ch.setIds(toSelect.map(function (selected) {
